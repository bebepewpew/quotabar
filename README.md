...
| `scripts/` | `install-hooks`, `install-codex-skills`, `coverage`, `codex-parallel` and its own suite `test-codex-parallel`, `check-ci-gate`, `check-harness`, `test-workflows`, `wrapper-tests` |
